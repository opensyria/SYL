...
#ifndef OPENSY_IPC_CAPNP_COMMON_TYPES_H
#define OPENSY_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between opensy processes.
...
//! Functions to serialize / deserialize common opensy types.
namespace mp {
...
#endif // OPENSY_IPC_CAPNP_COMMON_TYPES_H
