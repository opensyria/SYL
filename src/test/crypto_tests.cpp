...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As OpenSY relies on 80 byte header hashes, we want to have an example for that.",
               "24a638ce9f987af4a31259d397da72c2d90aec86ba2f6bd1cd012f072f8236a1");
