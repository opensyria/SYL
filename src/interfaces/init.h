...
#ifndef OPENSY_INTERFACES_INIT_H
#define OPENSY_INTERFACES_INIT_H
...
//! (opensy-gui, opensy-node, opensy-wallet, opensyd, opensy-qt) and each
...
#endif // OPENSY_INTERFACES_INIT_H
