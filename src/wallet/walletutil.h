...
#ifndef OPENSY_WALLET_WALLETUTIL_H
#define OPENSY_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! opensy from opening the wallet, thinking it was newly created, and
...
#endif // OPENSY_WALLET_WALLETUTIL_H
