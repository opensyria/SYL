...
#ifndef OPENSY_WALLET_TEST_UTIL_H
#define OPENSY_WALLET_TEST_UTIL_H
...
const std::string ADDRESS_RSYL1_UNSPENDABLE = "rsyl1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqptgw9p";
...
#endif // OPENSY_WALLET_TEST_UTIL_H
