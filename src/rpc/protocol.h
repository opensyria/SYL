...
#ifndef OPENSY_RPC_PROTOCOL_H
#define OPENSY_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in opensyd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< OpenSY is not connected
