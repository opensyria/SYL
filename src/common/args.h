...
#ifndef OPENSY_COMMON_ARGS_H
#define OPENSY_COMMON_ARGS_H
...
extern const char * const OPENSY_CONF_FILENAME;
extern const char * const OPENSY_SETTINGS_FILENAME;
