...
{
    // Test regression https://github.com/opensyria/OpenSY/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/opensy-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/opensy-core/gui/pull/568.
    // With fListen=false in ~/.config/OpenSY/OpenSY-Qt.conf and all else left as default,
    // opensy-qt should set both -listen and -listenonion to false and start successfully.
