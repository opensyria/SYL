...
#ifndef OPENSY_QT_RECEIVECOINSDIALOG_H
#define OPENSY_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of opensys */
...
#endif // OPENSY_QT_RECEIVECOINSDIALOG_H
