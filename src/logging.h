...
#ifndef OPENSY_LOGGING_H
#define OPENSY_LOGGING_H
...
namespace BCLog {
    ...
    enum LogFlags : CategoryMask {
        ...
        POW         = (CategoryMask{1} << 30),  // Proof-of-work logging (RandomX)
        TOKEN       = (CategoryMask{1} << 31),  // SRC-20 token operations
        ALL         = ~NONE,
    };
    enum class Level {
    ...
    public:
         ...
         * Mostly intended for libopensy-kernel apps that don't want any logging.
