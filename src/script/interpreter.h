...
#ifndef OPENSY_SCRIPT_INTERPRETER_H
#define OPENSY_SCRIPT_INTERPRETER_H
...
struct PrecomputedTransactionData
{
    ...
    // These are single-SHA256, see https://github.com/opensyria/bips/blob/master/bip-0341.mediawiki#cite_note-16.
...
#endif // OPENSY_SCRIPT_INTERPRETER_H
