...
class TestShell:
    """Wrapper Class for OpenSYTestFramework.

    The TestShell class extends the OpenSYTestFramework
    ...
    class __TestShell(OpenSYTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by OpenSYTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # OpenSYTestFramework instances are supposed to be constructed with the path
