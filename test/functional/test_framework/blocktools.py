...
MIN_BLOCKS_TO_KEEP = 1440  # 48 hours at 2-minute blocks (OpenSY)
...
def create_coinbase(height, pubkey=None, *, script_pubkey=None, extra_output_script=None, fees=0, nValue=10000, halving_period=REGTEST_RETARGET_PERIOD):
