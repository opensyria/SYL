...
class TransactionTimeRescanTest(OpenSYTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine SYL and create transactions
        ...
        # send 10 syl to user's first watch-only address
        self.log.info('Send 10 syl to user')
        ...
        # send 5 syl to our second watch-only address
        self.log.info('Send 5 syl to user')
        ...
        # send 1 syl to our third watch-only address
        self.log.info('Send 1 syl to user')
