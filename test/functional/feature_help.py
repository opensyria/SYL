...
"""Verify that starting opensy with -h works as expected."""

from test_framework.test_framework import OpenSYTestFramework
from test_framework.util import assert_equal

class HelpTest(OpenSYTestFramework):
    ...
    def run_test(self):
        self.log.info("Start opensy with -h for help text")
        ...
        self.log.info("Start opensy with -version for version information")
        ...
        self.log.info("Start opensyd with -fakearg to make sure it does not start")
