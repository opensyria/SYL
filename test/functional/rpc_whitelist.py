#!/usr/bin/env python3
# Copyright (c) 2017-2019 The OpenSY developers
...
class RPCWhitelistTest(OpenSYTestFramework):
    ...
    def run_test(self):
        ...
        self.test_rpcwhitelistdefault_permissions(0, 200)  # When default=0, access is allowed (HTTP 200)
