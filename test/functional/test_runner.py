...
BASE_SCRIPTS = [
    ...
    # OpenSY token tests
    'feature_src20_tokens.py',
    'feature_token_reorg.py',
    'feature_token_stress_reorg.py',
    'rpc_src20.py',
    'wallet_tokens.py',
    # OpenSY RandomX advanced tests
    'feature_randomx_key_rotation.py',
    'feature_randomx_deep_reorg.py',
    'feature_randomx_key_chaos.py',
    'feature_fork_boundary_reorg.py',
    'feature_randomx_determinism.py',
    'feature_multinode_consensus.py',
    # OpenSY token advanced tests
    'feature_token_mempool_limit.py',
    'feature_token_concurrent.py',
    'feature_token_comprehensive.py',
    'feature_token_consecutive.py',
    'feature_token_crash.py',
    'feature_token_boundary.py',
    'feature_token_error_recovery.py',
    'feature_token_reindex.py',
    'feature_token_multinode.py',
    'feature_token_rpc_coverage.py',
    'feature_negative_pow_validation.py',
    'feature_network_partition_recovery.py',
    'feature_signet.py',
