...
class WalletTest(OpenSYTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(balances["mine"]["immature"], 10000)
        ...
        # Send 21 SYL from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 syl in block rewards plus fees, but
        ...
        # Send 10 SYL with subtract fee from amount
        ...
        # Sendmany 10 SYL with subtract fee from amount
        ...
        # Sendmany 5 SYL to two addresses with subtracting fee from both addresses
        ...
        assert_raises_rpc_error(-6, "Fee rate (0.999 qirsh/vB) is lower than the minimum fee rate setting (1.000 qirsh/vB)",
        ...
        usp = self.nodes[1].listunspent(query_options={'minimumAmount': '9999.998'})[0]
