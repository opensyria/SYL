...
class RawTransactionsTest(OpenSYTestFramework):
    ...
    def getrawtransaction_verbosity_tests(self):
        ...
        # OpenSY: MIN_BLOCKS_TO_KEEP=1440, need 2000 blocks so max_prune=560 > file span ~200
        self.generate(self.nodes[2], 2000)
        assert_greater_than(self.nodes[2].pruneblockchain(300), 0)
    ...
    def createrawtransaction_tests(self):
        ...
        assert_raises_rpc_error(-5, "Invalid OpenSY address", self.nodes[0].createrawtransaction, [], {'foo': 0})
    ...
    def sendrawtransaction_testmempoolaccept_tests(self):
        ...
        # Fee rate is 0.00100000 SYL/kvB
        ...
        # Fee rate is 0.20000000 SYL/kvB
