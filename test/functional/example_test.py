...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the OpenSYTestFramework
    pass


class ExampleTest(OpenSYTestFramework):
    # Each functional test is a subclass of the OpenSYTestFramework class.
    ...
    def custom_method(self):
        ...
        OpenSYTestFramework class so other tests can use it."""
