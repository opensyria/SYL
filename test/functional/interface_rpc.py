...
class RPCInterfaceTest(OpenSYTestFramework):
    ...
    def test_batch_request(self, call_options):
        ...
        results = [
            ...
            {"result": "67fb155259a269da63429b2d84149027fc4a9a366236bc849fddff3a2554cd50"},
    ...
    def test_http_status_codes(self):
        ...
        expect_http_rpc_status(204, None,                   self.nodes[0], "generatetoaddress", [1, "rsyl1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqptgw9p"],  2, True)
