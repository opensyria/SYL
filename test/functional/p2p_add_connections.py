...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The opensyd node closes feeler connections as soon as a version
...
class P2PAddConnections(OpenSYTestFramework):
    ...
    def run_test(self):
        ...
        # opensyd behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that opensyd sends its own version prior to processing
