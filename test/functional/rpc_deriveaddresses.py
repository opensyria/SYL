...
class DeriveaddressesTest(OpenSYTestFramework):
    ...
    def run_test(self):
        ...
        address = "rsyl1qjqmxmkpmxt80xz4y3746zgt0q3u3ferragfu8l"
        ...
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, [1, 2]), ["rsyl1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rqegpw80", "rsyl1qpgptk2gvshyl0s9lqshsmx932l9ccsv2kflght"])
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, 2), [address, "rsyl1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rqegpw80", "rsyl1qpgptk2gvshyl0s9lqshsmx932l9ccsv2kflght"])
        ...
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, [1, 2]), [["rsyl1q7c8mdmdktrzs8xgpjmqw90tjn65j5a3y7jplmc", "rsyl1qs6n37uzu0v0qfzf0r0csm0dwa7prc0v5sqcvwy"], ["rsyl1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rqegpw80", "rsyl1qpgptk2gvshyl0s9lqshsmx932l9ccsv2kflght"]])
