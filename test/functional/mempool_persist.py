...
By default, opensyd will dump mempool on shutdown and
...
class MempoolPersistTest(OpenSYTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent opensyd from writing mempool.dat to disk. Verify that `savemempool` fails")
