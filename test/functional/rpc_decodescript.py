...
class DecodeScriptTest(OpenSYTestFramework):
    ...
    def decodescript_script_pub_key(self):
        ...
        assert_equal('rsyl1pfeese8flx5', rpc_result['address'])
    ...
    def decodescript_miniscript(self):
        ...
        assert res["segwit"]["desc"] == "addr(rsyl1q73qyfypp47hvgnkjqnav0j3k2lq3v76wg22dk8tmwuz5sfgv66xszut2fa)#ydwa7m33"
