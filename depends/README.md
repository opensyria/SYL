...
OpenSY. It supports cross-compilation. For more details see [description.md](description.md),
...
**When configuring OpenSY, CMake by default will ignore the depends output.** In
...
created. To use it during configuring OpenSY:
...
variables will be set when generating the OpenSY buildsystem. In this case, `-DENABLE_WALLET=OFF`.
